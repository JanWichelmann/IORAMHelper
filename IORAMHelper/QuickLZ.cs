// Nervige XML-Warnungen deaktivieren
#pragma warning disable 1591

// QuickLZ data compression library Copyright (C) 2006-2011 Lasse Mikkel Reinhold lar@quicklz.com
//
// QuickLZ can be used for free under the GPL 1, 2 or 3 license (where anything released into public must be open source) or under a commercial license if such has been acquired (see http://www.quicklz.com/order.html). The commercial license does not cover derived or ported versions created by third parties under GPL.
//
// Only a subset of the C library has been ported, namely level 1 and 3 not in streaming mode.
//
// Version: 1.5.0 final
